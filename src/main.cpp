...
// configuration step. It creates a namespace called `minesweeper_ftxui`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        minesweeper_ftxui::cmake::project_name,
        minesweeper_ftxui::cmake::project_version));// version string, acquired
